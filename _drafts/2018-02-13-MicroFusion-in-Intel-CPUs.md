...
Execution units can't execute fused uops, so are split at the execution stage in the pipeline.
...
`Picture of the pipeline with showing fused and unfused domain`
...
[Full assembly function](https://github.com/dendibakh/dendibakh.github.io/tree/master/_posts/code/MicroFusion/inc_simple_addressing.asm), [uarch-bench tests](https://github.com/travisdowns/uarch-bench/blob/0c4e467043d16dd955eaf09249a2f189f5ec2467/x86_methods.asm#L307).
...
[Full assembly function](https://github.com/dendibakh/dendibakh.github.io/tree/master/_posts/code/MicroFusion/add_complex_addressing.asm). See also microbenchmarks integrated into [uarch-bench](https://github.com/travisdowns/uarch-bench/blob/0c4e467043d16dd955eaf09249a2f189f5ec2467/x86_methods.asm#L307).
...
In this example `add ebx, DWORD [rsp + rdi * 4 - 4]` has 4 inputs: 3 registers and 1 FLAGS register. 
...
In this example `add DWORD [rsp + rdi * 4 - 4], 1` has 3 inputs: 2 registers and 1 FLAGS register. 
